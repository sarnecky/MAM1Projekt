...
public class VRGalleryActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener{
    private static final String TAG = VRGalleryActivity.class.getSimpleName();
    ...
    private class ActivityEventListener extends VrPanoramaEventListener {
        ...
        public void onLoadError(String errorMessage) {
            ...
            Toast.makeText(
                    VRGalleryActivity.this, "Error loading pano: " + errorMessage, Toast.LENGTH_LONG)
                    .show();
